...
获取单个 menu 的配置。menu 配置相关的可参考[这里](/v5/menu-config.html)。
...
编辑器 alert ，可通过 [customAlert](/v5/editor-config.html#customalert) 配置。
...
使用节点操作 API 前，请查看 [节点数据结构](/v5/node-define.html) 。
...
:::tip
全屏功能，有 html 结构的要求，请参考[这里](/v5/getting-started.html#全屏)
:::
